    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4">
      ...
      <motion.button
        ...
        className={cn(
          ...
          "border border-[#FFB800]/30 hover:border-[#FFB800]/50"
        )}
        aria-label="Scroll to top"
      >
        <ArrowUp className="w-6 h-6 text-[#FFB800] transform transition-transform group-hover:scale-110" />
        ...
        <div className={cn(
          ...
          Scroll to top
          <div className="absolute top-1/2 right-0 w-2 h-2 -mt-1 -mr-1 bg-black/90 transform rotate-45" />
        </div>
      </motion.button>
      ...
      <motion.button
        ...
        className={cn(
          ...
          "bg-[#25D366] shadow-lg",
          "flex items-center justify-center",
          "hover:shadow-xl hover:bg-[#20BA5C]",
          "transition-all duration-300",
          "group",
      ...
      >
        ...
        <div className="relative w-8 h-8">
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="w-full h-full text-white transform transition-transform group-hover:scale-110"
          >
            <path
